...
class ParameterizedPositionTest {
    ...
    void getPositionAt(Position position) {
        assertPosition(position.row() - 1, position.col(), position.getPositionAt(Direction.UP));
        assertPosition(position.row(), position.col() + 1, position.getPositionAt(Direction.RIGHT));
        assertPosition(position.row() + 1, position.col(), position.getPositionAt(Direction.DOWN));
        assertPosition(position.row(), position.col() - 1, position.getPositionAt(Direction.LEFT));
    }
